...
///   "installer_url": "https://github.com/cyberblob/SpamBayes_Rust/releases/download/v0.3.0-alpha.4/SpamBayes_Outlook_Setup_0.3.0a4.exe",
...
pub struct VersionManifest {
    /// The latest available semantic version (e.g., "0.3.0-alpha.4").
    pub version: String,
...
mod tests {
    ...
    fn test_parse_manifest_json() {
        let json = r#"{
            ...
            "release_date": "2026-07-14",
            "download_url": "https://github.com/cyberblob/SpamBayes_Rust/releases/latest",
            "installer_url": "https://github.com/cyberblob/SpamBayes_Rust/releases/download/v0.3.0-alpha.4/Setup.exe",
    ...
    fn test_parse_manifest_minimal_json() {
        ...
        let json = r#"{"version": "0.3.0-alpha.4", "build_number": 12345}"#;
        let manifest = VersionManifest::from_json(json).unwrap();
